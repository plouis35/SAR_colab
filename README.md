...
- attendre l'ouverture de l'onglet jupyter (il y a un bouton `show` pour visualiser l'avancement)
...
- récupérer et installer miniforge3 : `https://github.com/conda-forge/miniforge`
...
- attendre l'ouverture de l'onglet jupyter 
- double-cliquer sur le répertoire 'notebooks'
- double-cliquer sur un notebook pour l'ouvrir
- executer les cellules (SHIFT-ENTER)
